...
gsap.registerPlugin(useGSAP,Draggable,DrawSVGPlugin,EaselPlugin,Flip,GSDevTools,InertiaPlugin,MotionPathHelper,MotionPathPlugin,MorphSVGPlugin,Observer,PixiPlugin,ScrambleTextPlugin,ScrollTrigger,ScrollSmoother,ScrollToPlugin,SplitText,TextPlugin,RoughEase,ExpoScaleEase,SlowMo,CustomEase,CustomBounce,CustomWiggle);
import './gsapVerticalstyles.css'


function GsapVertical() {
...
let tl = gsap.timeline({paused:true, reversed:true});
  ...
  tl.to(toolTips[i], 0.25, {opacity:1, 
    //ease: "bounce.out"
...
// tween the dot animation as the draggable moves
  function tweenDot() {
   ...
   <div className="hideMe">
	...
	<p className="navDotInfo">The nav dots also have hover tooltips.</p>
	...
	<div id="panelWrap">
		...
		<section> <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/314556/greensock-logo.svg" alt="GreenSock Logo" width="360" />
		...
		<section> <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/314556/craigmasternew.png" width="100" alt="Craigs Avatar" />
			...
			<a href="https://twitter.com/Craig_PointC" target="_blank" className="twitterFollow">Follow @Craig_PointC</a> </section>
	</div>
      </div>
	<div className="dots">
	</div>
